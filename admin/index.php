...
?> 
    ...
    <input type="text" name="username" value="<?=$data['username']?>" class="form-control" id="ptitle" placeholder="bouhadjar issam">
  </div>
        <div class="form-group col-md-6">
    ...
    <input type="text" name="userid" value="<?=$data['user_id']?>" class="form-control" id="psubtitle" placeholder="admin@exemple.com">
  </div>
         </div>
